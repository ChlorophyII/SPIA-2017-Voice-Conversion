...
attention_mec = tf.contrib.seq2seq.LuongAttention(64,outputs)
attention_cell = tf.contrib.rnn.LSTMCell(64)
attention_cell = tf.contrib.seq2seq.AttentionWrapper(attention_cell,attention_mec,alignment_history=True)

(outputs,state) = tf.nn.dynamic_rnn(attention_cell,outputs,dtype=tf.float32)
